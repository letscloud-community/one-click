...
variable "apt_packages" {
  type    = string
  default = "fail2ban mysql-server nginx php8.3-apcu php8.3-curl php8.3-mysql php8.3-fpm postfix python3-certbot-nginx software-properties-common"
}
